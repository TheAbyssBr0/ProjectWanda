...
def calc_coordinates(in_string):
	...
	for i in range(len(in_string)):
		if in_string[i].isalpha():
			...
			if (word in sw_targets) or (word[-3:] == "ing" and catch_continuous):
...
coordinates = calc_coordinates(in_file_string)
latest = 0
out_string = ""
